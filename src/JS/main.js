...
createContent('./src/img/cabmun-example.jpg', 'Fecha de CABMUN 2023', '23 - 25 Marzo 2023', 'Tienes la oportunidad de participar los días 23, 24 y 25 del mes de marzo en la Primera Edición del Modelo de Naciones Unidas del Colegio Andrés Bello.', 'Inscripciones', 'https://forms.gle/ShssbRKpRJFxPdgW7', munInfo);

createContent('./src/img/cabmun-pnuma.jpg', 'Portada del comité PNUMA', 'PNUMA', 'Este es el comité del Programa de las Naciones Unidas para el Medio Ambiente, donde el tópico a debatir será la "Contaminación petrolífera en el Delta del Níger". La modalida de este comité será individual.', 'Matriz', 'https://drive.google.com/file/d/1tiVCyGx-LSy9cIik7bNy1CGry7lHgSSF/view?usp=sharing', munCommittees);
...
createContent('./src/img/cabmun-cdh.jpg', 'Portada del comité CDH', 'CDH', 'El Consejo de Derechos Humanos es el comité donde se estará debatiendo sobre las "Condiciones laborales de inmigrantes en Qatar". La modalida de este comité será agencia, es decir, pareja de participantes.', 'Matriz', 'https://drive.google.com/file/d/1tiVCyGx-LSy9cIik7bNy1CGry7lHgSSF/view?usp=sharing', munCommittees);
...
createContent('./src/img/cabmun-cpi.jpg', 'Portada del comité CPI', 'CPI', 'En el simulacro de la Corte Penal Internacional, el tema a tratar será la "Misión Internacional Independiente de Determinación de los Hechos sobre Venezuela". La modalida de este comité será individual.', 'Matriz', 'https://drive.google.com/file/d/1tiVCyGx-LSy9cIik7bNy1CGry7lHgSSF/view?usp=sharing', munCommittees);
